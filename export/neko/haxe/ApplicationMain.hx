...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("RunningMan", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("RunningMan", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "RunningMan";
		app.meta["name"] = "RunningMan";
